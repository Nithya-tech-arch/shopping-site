...
<html>
    <head>
        ...
        <title>Dior Furniture shop</title>
        <meta charset="UTF-8">
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Hola!! Furniture World!</h1>
                    <p>We have the best brands of all kinds of  for you. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sofas/changed.jpeg" alt="Cannon">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Cushioned chair </h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sofas/sofa_2.jpeg" alt="Sony DSLR">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Black Cushion</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sofas/sofa_3.jpeg" alt="Sony DSLR">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Blue pearled </h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sofas/sofa_4.jpeg" alt="Olympus">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Black crodged cushion</h3>
                                    <p>Price: Rs. 3000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sofas/sofa_5.jpeg" alt="Titan 301">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Guest chair</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sofas/sofa_6.jpeg" alt="Titan 201">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Orange lightweight </h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sofas/sofa_7.jpeg" alt="htm milan">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>4 Meet chairs</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sofas/sofa_8.jpeg" alt="Favre Leuba">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Work friendly chairs</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sofas/sofa_9.jpeg" alt="Raymond shirt">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sofas/sofa_10.jpeg" alt="Charles shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>pre-maternal</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sofas/sofa_11.jpeg" alt="HXR">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Cool Chairs</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sofas/sofa_12.jpeg" alt="PINK">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Cushions</h3>
