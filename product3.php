            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/dines/dine_1.jpeg" alt="Cannon">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/dines/dine_2.jpeg" alt="Sony DSLR">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Black Cushion</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/dines/dine_3.jpeg" alt="Sony DSLR">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Blue pearled </h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/dines/dine_4.jpeg" alt="Olympus">
                            </a>
                            <center>
                                <div class="caption">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/dines/dine_a.jpeg" alt="Titan 301">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Guest chair</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/dines/dine_6.jpeg" alt="Titan 201">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/dines/dine_7.jpeg" alt="htm milan">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>4 Meet chairs</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/dines/dine_c.jpeg" alt="Favre Leuba">
                            </a>
                            <center>
                                <div class="caption">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/dines/dine_9.jpeg" alt="Raymond shirt">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/dines/dine_10.jpeg" alt="Charles shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>pre-maternal</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/dines/dine_11.jpeg" alt="HXR">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Cool Chairs</h3>
                        ...
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/dines/dine_a.jpeg" alt="PINK">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Cushions</h3>
